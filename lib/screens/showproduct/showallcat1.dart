...
class ShowCategory extends StatefulWidget {
  late String value;
  ShowCategory({required this.value});
  //const ListCategory({Key? key}) : super(key: key);

  @override
  State<ShowCategory> createState() => _ShowCategoryState(value);
}

class _ShowCategoryState extends State<ShowCategory> {
  String value;
  _ShowCategoryState(this.value);
  @override
  scroll() {
                ...
                child: ListView(
                  ...
                  children: snapshot.data!.docs.map((document) {
                    return
                      InkWell(
                        onTap: (){
                          Navigator.push(context, MaterialPageRoute(builder: (context)=>ShowAllCateProducts(value:document['category'], venderId: value, )));
                        },
                        child: Padding(
