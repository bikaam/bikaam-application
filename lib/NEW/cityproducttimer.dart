...
class CityProductTimer extends StatefulWidget {
  late String value;

  CityProductTimer({required this.value});

  @override
  State<CityProductTimer> createState() => _CityProductTimerState(value);
}

class _CityProductTimerState extends State<CityProductTimer> {
  String value;
  _CityProductTimerState(this.value);
  int sum=0;
  ...
  Widget build(BuildContext context) {
    ...
    CollectionReference ref= FirebaseFirestore.instance.collection(value).doc("products").collection("Timer");
    return
      Container(
        height:300,
        width: 200,
